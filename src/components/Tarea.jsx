  ...
  return (
    <div className="border-b p-5 flex justify-between items-center ">
      ...
      <div className="flex justify-end gap-2 flex-wrap">
        <button className="bg-amber-500 px-4 py-2 text-white uppercase font-bold rounded-lg border hover:border-amber-700 hover:bg-amber-600 transition">
          Editar
        </button>
        ...
        <button className="bg-red-600 px-4 py-2 text-white uppercase font-bold rounded-lg border hover:border-red-800 hover:bg-red-700 transition">
          Eliminar
        </button>
      </div>
    </div>
