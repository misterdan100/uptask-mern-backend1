...
const ModalEliminarTarea = () => {
  const { modalEliminarTarea, handleModalEliminarTarea, eliminarTarea, alerta } = useProyectos();
          ...
          >
            <div className="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
              ...
              <div className="sm:flex sm:items-start">
                <div className="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10 hover:scale-110 transition">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Las tareas que se eliminen no se podran recuperar.
                    </p>
                  </div>
                </div>
              </div>
